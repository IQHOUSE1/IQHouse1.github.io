(function ($) {
 "use strict";
    ...
    $('form#cf button#submit').on('click', function() {
        ...
        if (!regex.test(email)) {
            alert('Veullez saisir un email correct');
            return false;
        }
        ...
        if (fname != '' && email != '' && msg != '') {
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $('.cf-msg').fadeIn().html('<div class="alert alert-success"><strong>Message envoyé!</strong> Votre email a bien été envoyé.</div>');
                    setTimeout(function() {
                        $('.cf-msg').fadeOut('slow');
                    }, 4000);
                }
            ...
            $('.cf-msg').fadeIn().html('<div class="alert alert-danger"><strong>Attention!</strong> Veuillez renseigner correctement les champs.</div>')
        }
        return false;
    });
